                ...
                <div className="col-md-12">
                    <div className="sc-heading style-2">
                        <div className="content-left">
                            <div className="inner">
                                <h3>Best Sellers</h3>
                                <p className="desc">Mes projets React</p>
                            </div>
                        </div>
                        <div className="content-right">
                            <Link to="/explore-01" className="sc-button style letter style-2"><span>Explore More Coming Soon </span> </Link>
                        </div>
                    </div>
                </div>
                <div className="col-md-12">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="slider-item">
                                            <div className="sc-author">
                                                ...
                                                <Link to="/login" className="sc-button btn-bordered-white"><span>Learn</span></Link>
                                            </div>
                                        </div>
                                    </div>
                                </SwiperSlide>
